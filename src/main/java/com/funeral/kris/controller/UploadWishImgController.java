...
@Controller
@RequestMapping(value = "/uploadWishImg")
public class UploadWishImgController extends HttpServlet {
	...
	public void upload(HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		String rerurnUrl="<script> window.location='/funeral/pages/configuration/wishConfiguration/addProduct.html?id=$' ;window.close();</script>";
	...
	public void uploadImg(Integer wishId, String imgPath) {
		Wish wish = wishService.getResource(wishId);

		wish.setImgUrl(imgPath);
				...
				while (items.hasNext()) {
					...
					if (!item.isFormField()) {
						...
						System.out.println(" actionTypes= " + actionTypes + " fileName= " + fileName+" loadPath="+loadPath);
							...
							this.uploadImg(wishId, loadPath);
