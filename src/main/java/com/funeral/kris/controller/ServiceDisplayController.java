			...
			while (serviceCategoryClassIterator.hasNext()) {
				...
				if (tServiceCategoryClass.getCateId().equals(tServiceCategory.getCateId())) {
					...
					if (tServiceCategoryClass.getClassId() == 0) {
						...
						String unSelectStyle = "height:179px;width:179px;border-radius:179px;float:left;position:relative;top:10px;left:10%;padding-left:0px;border:0px solid blue";
						...
						String selectStyle = "height:179px;width:179px;border-radius:179px;float:left;position:relative;top:10px;left:10%;padding-left:0px;border:3px solid #ff5274";
						...
						String unSelectStyle = "height:179px;width:179px;border-radius:179px;float:left;position:relative;top:10px;left:13%;padding-left:0px;border:0px solid blue";

						unSelectStyle = unSelectStyle + ";background:url" + "(" + QUESTION.rootPath
								+ tServiceCategoryClass.getimgUrldefault() + ");background-repeat:no-repeat;";
						String selectStyle = "height:179px;width:179px;border-radius:179px;float:left;position:relative;top:10px;left:13%;padding-left:0px;border:3px solid #ff5274";
						...
						String unSelectStyle = "height:179px;width:179px;border-radius:179px;float:left;position:relative;top:10px;left:16%;padding-left:0px;border:0px solid blue";

						unSelectStyle = unSelectStyle + ";background:url" + "(" + QUESTION.rootPath
								+ tServiceCategoryClass.getimgUrldefault() + ");background-repeat:no-repeat;";
						String selectStyle = "height:179px;width:179px;border-radius:179px;float:left;position:relative;top:10px;left:16%;padding-left:0px;border:3px solid #ff5274";
						...
						String unSelectStyle = "height:179px;width:179px;border-radius:179px;float:left;position:relative;top:10px;left:19%;padding-left:0px;border:0px solid blue";

						unSelectStyle = unSelectStyle + ";background:url" + "(" + QUESTION.rootPath
								+ tServiceCategoryClass.getimgUrldefault() + ");background-repeat:no-repeat;";
						String selectStyle = "height:179px;width:179px;border-radius:179px;float:left;position:relative;top:10px;left:19%;padding-left:0px;border:3px solid #ff5274";
