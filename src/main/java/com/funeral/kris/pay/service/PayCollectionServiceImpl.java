...
public class PayCollectionServiceImpl implements PayCollectionService {
	...
	public int completeCollection(Map<String, String> params) throws Exception {
		...
		System.out.println(this.getClass() + "   completeCollection    params="
				+ params);
		...
		System.out.println(this.getClass()
				+ "   completeCollection    orderNo=" + orderNo);

		TFeeCollection feeCollection = this
				.loadPayableFeeCollectionByOrderNo(orderNo);

		System.out.println(this.getClass()
				+ "   completeCollection    feeCollection=" + feeCollection);
		...
		feeCollection.setCollectionType(Integer.parseInt(params
				.get("collection_type")));
		dao.saveFeeCollection(feeCollection);

		System.out.println(this.getClass()
				+ "   completeCollection    ---------------order---" + orderNo);
		...
		System.out.println(this.getClass()
				+ "  before getUncompledExpressInfoByWishOrderId  wishOrderId"
				+ wishOrderId + "  ");

		ExpressInfo currentExpress = dao.getUncompledExpressInfoByWishOrderId(
				wishOrderId, EXPRESS.express_status_init);
		...
		dao.updateWishOrderStatus(order.getWishOrderId(),
				WishConstants.wishorder_status_paied);

		List<OrderDetail> orderDetailList = orderDetailService
				.getOrderListyWishOrderId(order.getWishOrderId());
